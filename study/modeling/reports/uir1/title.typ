...
// Копия study/os/reports/intro-exp/title.typ с другими значениями по умолчанию.
// Если шаблон понадобится третьему предмету — вынести в общее место.
#let titlepage(
  ...
  discipline: "Моделирование",
  work-kind: "Отчёт по учебно-исследовательской работе № 1",
  title: "",
  student: "",
  group: "",
  teacher: "",
